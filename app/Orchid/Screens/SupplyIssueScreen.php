...
class SupplyIssueScreen extends Screen
{
    ...
    {
        // $data = $request->get('supplies');
        // $supplyId = key($data);
        // $issueQuantity = $data[$supplyId]['issue_quantity'];

        // $supply = Supply::find($supplyId);

        // if ($supply->issue($issueQuantity)) {
        //     Alert::info('Товар успешно выдан');
        // } else {
        //     Alert::error('Недостаточно товара на складе');
        // }
        // SupplyIssue::create([
